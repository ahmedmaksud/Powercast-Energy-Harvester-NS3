 ...
 * Authors: IPCCC Team
 *
 * ph_powercast_energy_harvester_helper.cc - Advanced PowerCast Deployment Helper Implementation
 *
...
PowercastEnergyHarvesterHelper::ApplyTemplate(DeploymentTemplate templateType)
{
    ...
    {
    case UNIFORM_A1:
        // All devices: 50000μF (50mF) capacitor, 1.2V thresholds
    ...
    case UNIFORM_B2:
        // All devices: 2200μF capacitor, 0.9V thresholds
    ...
    case HIGH_CAPACITY:
        // Large capacitors only
        m_templateCapClasses.push_back(PowercastEnergyHarvester::CLASS_A); // 50000μF (50mF)
        m_templateCapClasses.push_back(PowercastEnergyHarvester::CLASS_C); // 200000μF (200mF)
        m_templateVoltClasses.push_back(PowercastEnergyHarvester::CLASS_1);
        m_templateVoltClasses.push_back(PowercastEnergyHarvester::CLASS_2);
...
PowercastEnergyHarvesterHelper::ExportConfigurationToFile(const std::string& filename) const
{
    ...
    configFile << "# CapacitorClass: A(50000μF/50mF), B(2200μF), C(200000μF/200mF)" << std::endl;
